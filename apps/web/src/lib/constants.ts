export const NAV_ITEMS = [
  ...
  { href: '/discovery', label: 'Proof Discovery', icon: 'search' },
  { href: '/trust-signals', label: 'Trust Signals', icon: 'shield' },
  ...
  { href: '/growth', label: 'Growth Recommendations', icon: 'trending' },
...
export const ICON_PATHS: Record<string, string> = {
  ...
  trophy: 'M5 3h14M7 3v2a5 5 0 0010 0V3M9 21h6M12 17v4',
  users: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
  bell: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9',
  rocket: 'M15.59 14.37a2 2 0 010 2.996l-2.008 2.008a2 2 0 01-2.996 0l-6.416-6.416a2 2 0 010-2.996l2.008-2.008a2 2 0 012.996 0l6.416 6.416z',
